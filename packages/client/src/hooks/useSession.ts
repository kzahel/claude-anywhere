...
export function useSession(
  ...
  // Markdown augments loaded from REST response (keyed by blockId: messageId-blockIndex)
  // Contains pre-rendered HTML with syntax highlighting for historical messages
  ...
  useEffect(() => {
    ...
    api
      ...
      .then((data) => {
        ...
        // Store markdown augments from REST response (pre-rendered HTML with highlighting)
